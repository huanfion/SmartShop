...
using SmartShop.Sessions;
using SmartShop.Web.Controllers.Results;
using SmartShop.Web.Models;
using SmartShop.Web.Models.Account;
...
{
    public class AccountController : SmartShopControllerBase
    {
